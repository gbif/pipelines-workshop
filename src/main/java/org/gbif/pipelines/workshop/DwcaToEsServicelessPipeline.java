...
public class DwcaToEsServicelessPipeline {

  private static final Logger LOG = LoggerFactory.getLogger(DwcaToEsServicelessPipeline.class);

  private DwcaToEsServicelessPipeline() {}
